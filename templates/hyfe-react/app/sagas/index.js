 ...
 * @Last Modified time: 2018-09-13 17:47:33
  */
...
import {
  ...
  fetchDeleteProduct,
  fetchUpdateCatalogue,
  fetchUpdateProduct,
  fetchCatalogueDetail,
  fetchProductDetail,
} from './configuration/indexSaga'
...
export default function* root() {
  yield all([
    fork(fetchTreeNav),
    fork(fetchAddCatalogue),
    fork(fetchAddProduct),
    fork(fetchDeleteCatalogue),
    fork(fetchDeleteProduct),
    fork(fetchUpdateCatalogue),
    fork(fetchUpdateProduct),
    fork(fetchCatalogueDetail),
    fork(fetchProductDetail),
  ])
}
